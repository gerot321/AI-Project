package com.example.gerrys.pattern;
...
import com.example.gerrys.pattern.models.Classification;
import com.example.gerrys.pattern.models.Classifier;
import com.example.gerrys.pattern.models.TensorFlowClassifier;
import com.example.gerrys.pattern.views.DrawModel;
import com.example.gerrys.pattern.views.DrawView;
            ...
            public void onClick(View v) {
                ...
                for (Classifier classifier : mClassifiers) {
                    ...
                    if (res.getLabel() == null) {
                        text += classifier.name() + ": unrecognized\n";
                    } else {
